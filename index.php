...
<body>
  ...
  <div class="col-lg-12 text-center pt-5 pb-5" style="margin-top: 50px;">
    <div class="col-lg-12 text-center py-4 pt-4 mt-5 px-5 px-sm-5 banner-content" style="padding-top: 120; ">
      <div class="container px-3 py-5" style="max-width: 1000px; margin-top: 50px;">
        <h1 class="fw-semibold text-center pb-3 responsive-heading"
        ...
        <h5 class="pb-3 text-center responsive-subheading" style="font-family: 'Poppins', sans-serif; color: #0E171F;">
        ...
        <ul class="list-unstyled ps-2 ps-md-4 mt-4">
          ...
          <li class="mb-3">
            <div class="container mobileview" style="font-family: 'Lexend', sans-serif; max-width: 90%;">
              <h3 class="fw-bold py-3 pb-5" style="color: #891014;">
              ...
              <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-12 col-md-12 text-start">
                  <img
                    src="assets/Logos/ClientBase Platform Logo/SVG/ClientBase Platform Logo FullColour - Black Text (transparent bg).svg"
                    alt="Clinebook_logo" class="img-fluid rounded-5 logo-fixed pt-5">
    ...
    <div class="container-fluid" style="max-width: 100%;">
      <div class="row">
        ...
        <div class="col-md-9 text-start mb-3 mb-md-0">
          <h1 class="mb-0 fw-semibold">Master Your <br> Client's Domain.</h1>
  ...
  <footer class="text-white py-4 d-block d-md-none"
    ...
    <div class="container px-3">
      ...
      <div class="row align-items-center text-start">
        <div class="col-6">
          <h2 class="fw-bold mb-3">Master Your <br> Client's Domain.</h2>
        ...
        <div class="col-6 text-end">
          ...
          <div class="col-3 d-flex justify-content-start">
            <img
              src="assets/Logos/ClientBase Platform Logo/SVG/ClientBase Platform Logo FullColour - White Text (transparent bg).svg"
              alt="Banner Preview" class="img-fluid" style="max-width: 150px;">
          </div>
